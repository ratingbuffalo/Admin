// js/popular-movies.js (finalized)
document.addEventListener("DOMContentLoaded", () => {
  const moviesGrid = document.querySelector(".popular-grid");
        ...
        (async () => {
          try {
            ...
            if (details && typeof details.runtime === "number") {
              ...
              durBadge.textContent = formatted || "N/A";
              durText.textContent = formatted || "N/A";
              durBadge.classList.toggle("na", !formatted);
              durText.classList.toggle("na", !formatted);
            } else {
